...
class ProgressBarUi : BasicProgressBarUI() {
    ...
    init {
        runCatching {
            bimage = ImageIO.read(this.javaClass.getResource("/bricks.png"))
        }.onFailure {
            it.printStackTrace()
        }
    }
    ...
    override fun paintDeterminate(g: Graphics, c: JComponent) {
        ...
        MarioProgressBarSettingsState.instance.selectedCharacter.icon.paintIcon(
            progressBar,
            g2,
    ...
    private val periodLength: Int
        private get() = JBUIScale.scale(16)
